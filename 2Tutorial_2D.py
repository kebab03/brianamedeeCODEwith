...
class GraphingIntro(Scene):
    def construct(self):
        ...
        code = Code("Math.py", style=Code.styles_list[12], background ="window", language = "python", insert_line_no = True,
...
class Tute1(Scene): #ILLUSTRATING HOW TO PUT A NUMBER PLANE ON SCENE WITH A GRAPH, and a line using c2p
    def construct(self):
        ...
        code = Code("Mcode1.py", style=Code.styles_list[12], background ="window", language = "python", insert_line_no = True,
        tab_width = 2, line_spacing = 0.3 , font="Monospace").set_width(7).to_edge(UL, buff=0)
...
class Tute3(Scene): #Showing how to call 2 planes, put graphs on each and call elements to each
    def construct(self):
        ...
        code = Code("Latex.py", style=Code.styles_list[12], background ="window", language = "python", insert_line_no = True,
